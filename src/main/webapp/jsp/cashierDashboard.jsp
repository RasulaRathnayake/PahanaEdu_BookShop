...
<head>
    ...
    <title>Cashier Dashboard - Pahana Edu Book Shop</title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-header">
            ...
            <div class="logo-text">
                ...
                <div class="logo-subtitle">Cashier Dashboard</div>
            </div>
        </div>
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <a href="<%=request.getContextPath()%>/jsp/billing.jsp" class="nav-item active" onclick="setActive(this)">
                    ...
                    <div class="nav-item-text">Invoice Management</div>
                </a>
    ...
    <script>
        ...
        const navItems = [
            { 
                href: '<%=request.getContextPath()%>/jsp/billing.jsp', 
